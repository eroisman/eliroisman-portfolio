...
var url = 'https://gnews.io/api/v4/search?q=rançongiciel&lang=fr&country=fr&max=9&apikey=' + apiKeyGNews;
...
fetch(url)
  ...
  .then(function (data) {
    ...
    if (data.articles && data.articles.length > 0) {
      ...
      newsFeedContainer.innerHTML = "<p>Pas d'articles disponibles</p>";
    }
  })
